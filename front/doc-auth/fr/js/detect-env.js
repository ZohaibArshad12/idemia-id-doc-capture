...
function displayEnvironement (env) {
  ...
  if (env.envDetected) {
    ...
    if (!envOS.isSupported) {
      ...
      envDetectionPage.querySelector(descriptionClass).textContent = "Vous semblez utiliser un système d'exploitation non pris en charge.";
      browsersDescription.textContent = "Veuillez utiliser l'un des systèmes d'exploitation suivants pour une meilleure expérience";
      ...
      document.querySelector(stepCountrySelectionId).className = document.querySelector(stepCountrySelectionId).className.concat('d-none');
      envDetectionPage.className = envDetectionPage.className.replace('d-none', '');
      envDetectionPage.querySelector(descriptionClass).textContent = "Vous semblez utiliser un navigateur incompatible.";
      browsersDescription.textContent = "Veuillez utiliser l'un des navigateurs suivants pour une meilleure expérience";
